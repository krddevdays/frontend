...
const BreakfastPage: NextPageWithLayout = () => {
    return (
        <div className={classNames('relative h-screen overflow-hidden')}>
            <div
                className={classNames('max-w-full 2xl:max-w-screen-2xl 2xl:mx-auto relative z-30 min-h-full flex flex-col justify-items-start')}>
                        ...
                        <div
                            ...
                            <div>
                                <div className='pt-[8px] sm:pt-[12px] md:pt-[18px] flex flex-row justify-items-start'>
                                    <img src={calendarImage.src} className='w-[24px] h-[24px] sm:w-[18px] sm:h-[18px] md:w-[24px] md:h-[24px]' alt='' />
                                ...
                                <div className='pt-[18px] sm:pt-[12px] md:pt-[18px] flex flex-row justify-items-start'>
                                    <img src={locationImage.src} className='w-[24px] h-[24px] sm:w-[18px] sm:h-[18px] md:w-[24px] md:h-[24px]' alt='' />
                                    <a href='https://yandex.ru/maps/-/CCUReFttdC' target='_blank' className='inline-block pl-[16px] underline' rel="noreferrer">
                                        Coffee Set<br />
                                        ул. Чапаева, 86
                                    </a>
                                </div>
            ...
            >
                ...
                <source src='https://storage.yandexcloud.net/krddev-static/breakfast-video.hevc.mp4' type='video/mp4; codecs="hvc1"' />
