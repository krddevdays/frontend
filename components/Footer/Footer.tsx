        ...
        icon: function YouTubeIcon(props: React.SVGProps<SVGSVGElement>) {
            return (
                <svg fill='currentColor' viewBox='0 0 33 24'  {...props}>
                    <path
                        d='M30 5.12a3.55 3.55 0 00-2.55-2.52C25.22 2 16.29 2 16.29 2s-8.94 0-11.17.6A3.56 3.56 0 002.6 5.12 37 37 0 002 12a37 37 0 00.6 6.88 3.56 3.56 0 002.52 2.52c2.23.6 11.17.6 11.17.6s8.93 0 11.16-.6A3.55 3.55 0 0030 18.88a37 37 0 00.6-6.88 37 37 0 00-.6-6.88zM13.43 16.29V7.71L20.85 12z' />
                </svg>
            );
        }
    },
        ...
        <footer className='bg-white'>
            <div className='max-w-7xl mx-auto py-12 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8'>
                <div className='flex justify-center space-x-6 md:order-2'>
                    {navigation.map((item) => (
                        <a key={item.name} href={item.href} className='text-gray-400 hover:text-gray-500' target="_blank" rel="noreferrer noopener">
